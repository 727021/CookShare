...
| Edit a recipe              | PUT    | `/recipe`       | title, description, serving, ingredients, steps, images | 200          | `<Recipe>`    | Expects images as multipart form data |
| Delete a recipe            | DELETE | `/recipe`       |                                                         | 204          |               |                                       |
...
| Add a recipe to a cookbook           | POST   | `/cookbook/recipe`       | cid, rid          | 201          | `<Cookbook>`                                                                                             |                       |
| Remove a recipe from a cookbook      | DELETE | `/cookbook/recipe`       | cid, rid          | 200          | `<Cookbook>`                                                                                             |                       |
| Share a cookbook with another user   | POST   | `/cookbook/share`        | cid, uid, status  | 201          | `<Cookbook>`                                                                                             |                       |
| Change another user's sharing status | PUT    | `/cookbook/share`        | cid, uid, status  | 200          | `<Cookbook>`                                                                                             |                       |
| Remove another user from a cookbook  | DELETE | `/cookbook/share`        | cid, uid          | 204          |                                                                                                          |                       |
| Add a comment to a recipe            | POST   | `/cookbook/comment`      | cid, rid, message | 201          | `[{_id: String, author: <User>, date: Date, message: String}]`                                           |                       |
| Edit a comment on a recipe           | PUT    | `/cookbook/comment`      | cid, rid, message | 200          | `[{_id: String, author: <User>, date: Date, message: String}]`                                           |                       |
| Delete a comment on a recipe         | DELETE | `/cookbook/comment`      | cid, rid          | 204          |                                                                                                          |                       |
| Get cookbook information             | GET    | `/cookbook/:cid`         | cid               | 200          | `<Cookbook>`                                                                                             |                       |
| Get recipe comments                  | GET    | `/cookbook/:cid/comment` | cid, rid          | 200          | `[{_id: String, author: <User>, date: Date, message: String}]`                                           |                       |
...
| Edit cookbook title                  | PUT    | `/cookbook`              | cid, title        | 200          | `<Cookbook>`                                                                                             |                       |
| Delete a cookbook                    | DELETE | `/cookbook`              | cid               | 204          |                                                                                                          |                       |
