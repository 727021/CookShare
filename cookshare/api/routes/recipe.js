...
const { needsAuth, needsAdmin } = require('../middleware')
...
router
    ...
    .post(
        ...
        [
            ...
            body(
                'description',
                'Description must be shorter than 1024 characters.'
            )
                .optional()
                .isString()
                .trim()
            ...
            body('serving.count', 'Serving count must be at least 1.').isInt({
                min: 1
            }),
            body(
                'serving.size',
            ...
            body('ingredients', 'Ingredients cannot be empty.').custom(
            ...
            body('ingredients.*.units', 'Invalid units.')
                ...
                .trim()
                .custom((value, { req }) => Unit.exists(value)),
            body('steps', 'At least one step is required.')
                .isArray()
                .notEmpty(),
    ...
    .put(
        ...
        [
            ...
            body('steps', 'At least one step is required.')
                .isArray()
                .custom((value, { req }) => value.length > 0),
            body('steps.*', 'Step cannot be empty.')
                .isString()
                .notEmpty()
                .trim()
